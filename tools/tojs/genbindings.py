...
def main():
    ...
    try:
        ...
        output_dir = '%s/extensions/scripting/js-bindings/bindings' % project_root

        cmd_args = {
                    'ax_base.ini' : ('ax_base', 'axjs_base_auto'), \
                    'ax_rhi.ini' : ('ax_rhi', 'axjs_rhi_auto'), \
                    'ax_extension.ini' : ('ax_extension', 'axjs_extension_auto'), \
                    'ax_ui.ini' : ('ax_ui', 'axjs_ui_auto'), \
                    'ax_studio.ini' : ('ax_studio', 'axjs_studio_auto'), \
                    'ax_spine.ini' : ('ax_spine', 'axjs_spine_auto'), \
                    'ax_physics.ini' : ('ax_physics', 'axjs_physics_auto'), \
                    'ax_video.ini' : ('ax_video', 'axjs_video_auto'), \
                    'ax_controller.ini' : ('ax_controller', 'axjs_controller_auto'), \
                    'ax_3d.ini': ('ax_3d', 'axjs_3d_auto'), \
                    'ax_audioengine.ini': ('ax_audioengine', 'axjs_audioengine_auto'), \
                    'ax_csloader.ini' : ('ax_csloader', 'axjs_csloader_auto'), \
                    'ax_webview.ini' : ('ax_webview', 'axjs_webview_auto'), \
                    'ax_physics3d.ini' : ('ax_physics3d', 'axjs_physics3d_auto'), \
                    'ax_navmesh.ini' : ('ax_navmesh', 'axjs_navmesh_auto'), \
                    'ax_fairygui.ini' : ('ax_fairygui', 'axjs_fairygui_auto'), \
                    }
        target = 'js'
        ...
        print('---------------------------------')
        print('Generating js bindings succeeds.')
        print('---------------------------------')

    except Exception as e:
        if e.__class__.__name__ == 'CmdError':
            print('---------------------------------')
            print('Generating js bindings fails.')
            print('---------------------------------')
            sys.exit(1)
        else:
            raise
