...
V8PP_IMPL v8::Local<v8::Value> throw_ex(v8::Isolate* isolate,
                                        std::string_view message,
                                        exception_ctor ctor,
                                        v8::Local<v8::Value> exception_options)
{
    v8::Local<v8::String> msg =
        v8::String::NewFromUtf8(isolate, message.data(), v8::NewStringType::kNormal, static_cast<int>(message.size()))
            .ToLocalChecked();
...
V8PP_IMPL v8::Local<v8::Value> throw_error(v8::Isolate* isolate,
                                           std::string_view message,
                                           v8::Local<v8::Value> exception_options)
{
...
V8PP_IMPL v8::Local<v8::Value> throw_range_error(v8::Isolate* isolate,
                                                 std::string_view message,
                                                 v8::Local<v8::Value> exception_options)
{
...
V8PP_IMPL v8::Local<v8::Value> throw_reference_error(v8::Isolate* isolate,
                                                     std::string_view message,
                                                     v8::Local<v8::Value> exception_options)
{
...
V8PP_IMPL v8::Local<v8::Value> throw_syntax_error(v8::Isolate* isolate,
                                                  std::string_view message,
                                                  v8::Local<v8::Value> exception_options)
{
...
V8PP_IMPL v8::Local<v8::Value> throw_type_error(v8::Isolate* isolate,
                                                std::string_view message,
                                                v8::Local<v8::Value> exception_options)
{
