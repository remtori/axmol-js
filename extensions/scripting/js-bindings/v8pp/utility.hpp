...
template <typename T>
concept String =
    std::same_as<T, std::string> || std::same_as<T, std::string_view> || std::same_as<T, std::wstring> ||
    std::same_as<T, std::wstring_view> || std::same_as<T, std::u16string> || std::same_as<T, std::u16string_view> ||
    std::same_as<T, std::u32string> || std::same_as<T, std::u32string_view> || std::same_as<T, char const*> ||
    std::same_as<T, char16_t const*> || std::same_as<T, char32_t const*> || std::same_as<T, wchar_t const*>;
