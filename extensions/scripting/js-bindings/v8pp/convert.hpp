...
struct convert<T>
{
    ...
    static from_type from_v8(v8::Isolate* isolate, v8::Local<v8::Value> value)
    {
        ...
        if constexpr (sizeof(Char) == 1)
        {
            ...
            from_type result(len, 0);
            result.resize(str->WriteUtf8(isolate, result.data(), len, nullptr,
        ...
        else
        {
            auto const len = str->Length();
            from_type result(len, 0);
            result.resize(str->Write(isolate, reinterpret_cast<uint16_t*>(result.data()), 0, len,
...
struct convert<T>
{
    ...
    static bool is_valid(v8::Isolate*, v8::Local<v8::Value> value)
    {
        return !value.IsEmpty() && (value->IsNumber() || value->IsBoolean());
    }
...
private:
    ...
    static from_type from_v8_impl(v8::Isolate* isolate, v8::Local<v8::Value> value, std::index_sequence<Is...>)
    {
        ...
        return T{
            v8pp::convert<std::tuple_element_t<Is, T>>::from_v8(isolate, array->Get(context, Is).ToLocalChecked())...};
    }

    template <size_t... Is>
    static to_type to_v8_impl(v8::Isolate* isolate, T const& value, std::index_sequence<Is...>)
    {
        ...
        (void)std::initializer_list<bool>{
            result->Set(context, Is, convert<std::tuple_element_t<Is, T>>::to_v8(isolate, std::get<Is>(value)))
                .FromJust()...};
...
struct convert<std::variant<Ts...>>
{
    ...
    static bool is_valid(v8::Isolate*, v8::Local<v8::Value> value) { return !value.IsEmpty(); }
    ...
    static from_type from_v8(v8::Isolate* isolate, v8::Local<v8::Value> value)
    {
        ...
        else if (value->IsObject())
        {
            ...
            {
                return alternate<detail::is_mapping, is_wrapped_class>(isolate, value);
            }
            else
            {
                return alternate<is_wrapped_class>(isolate, value);
            }
        }
        else
        {
...
private:
    ...
    static bool try_as(v8::Isolate* isolate, v8::Local<v8::Value> value, std::optional<from_type>& result)
    {
        ...
        {
            if (auto obj = v8pp::class_<T, v8pp::object_ptr_traits>::unwrap_object(isolate, value))
            {
                result = *obj;
            }
        }
...
template <typename T>
    requires detail::Sequence<T> || detail::Array<T>
struct convert<T>
{
    using from_type = T;
    using to_type   = v8::Local<v8::Array>;
    ...
    static bool is_valid(v8::Isolate*, v8::Local<v8::Value> value) { return !value.IsEmpty() && value->IsArray(); }
    ...
    static from_type from_v8(v8::Isolate* isolate, v8::Local<v8::Value> value)
    {
        ...
        {
            constexpr size_t length = std::tuple_size_v<T>;
            if (array->Length() != length)
            {
                throw std::runtime_error("Invalid array length: expected " + std::to_string(length) + " actual " +
                                         std::to_string(array->Length()));
            }
        }
        else if constexpr (detail::HasReserve<T>)
        {
...
template <typename T>
struct is_wrapped_class : std::conjunction<std::is_class<T>,
...
struct convert<T*>
{
    ...
    static bool is_valid(v8::Isolate*, v8::Local<v8::Value> value) { return !value.IsEmpty() && value->IsObject(); }
    ...
    static from_type from_v8(v8::Isolate* isolate, v8::Local<v8::Value> value)
    {
        ...
        return class_<class_type, object_ptr_traits>::unwrap_object(isolate, value);
    }

    static to_type to_v8(v8::Isolate* isolate, T const* value)
    {
        return class_<class_type, object_ptr_traits>::find_or_create_object(isolate, value);
    }
};
...
struct convert<T>
{
    ...
    static from_type from_v8(v8::Isolate* isolate, v8::Local<v8::Value> value)
    {
        ...
        T* object = class_<class_type, object_ptr_traits>::unwrap_object(isolate, value);
        if (object)
        {
            return *object;
        }
    ...
    static to_type to_v8(v8::Isolate* isolate, T const& value)
    {
        v8::Local<v8::Object> result = class_<class_type, object_ptr_traits>::find_or_create_object(isolate, value);
        if (!result.IsEmpty())
            return result;
...
auto from_v8(v8::Isolate* isolate, v8::Local<v8::Value> value, U const& default_value)
{
    ...
    return convert<T>::is_valid(isolate, value) ? convert<T>::from_v8(isolate, value)
...
template <size_t N>
v8::Local<v8::String> to_v8(v8::Isolate* isolate, wchar_t const (&str)[N], size_t len = N - 1)
{
    return convert<std::wstring_view>::to_v8(isolate, std::wstring_view(str, len));
}
#endif
...
inline invalid_argument::invalid_argument(v8::Isolate* isolate, v8::Local<v8::Value> value, char const* expected_type)
    : std::invalid_argument(
          std::string("expected ") + expected_type + ", typeof=" +
