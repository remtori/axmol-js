...
inline constexpr bool function_with_object =
...
inline constexpr bool is_getter =
    CallTraits::arg_count == 0 + Offset && !std::same_as<typename function_traits<F>::return_type, void>;

template <typename F, size_t Offset, typename CallTraits = call_from_v8_traits<F>>
inline constexpr bool is_direct_getter =
    CallTraits::arg_count == 2 + Offset &&
...
template <typename F, size_t Offset, typename CallTraits = call_from_v8_traits<F>>
inline constexpr bool is_isolate_getter = CallTraits::arg_count == 1 + Offset && is_first_arg_isolate<F, Offset> &&
                                          !std::same_as<typename function_traits<F>::return_type, void>;
...
template <typename F, size_t Offset, typename CallTraits = call_from_v8_traits<F>>
inline constexpr bool is_direct_setter =
    CallTraits::arg_count == 3 + Offset &&
    std::is_convertible_v<typename CallTraits::template arg_type<0 + Offset>, v8::Local<v8::Name>> &&
...
struct property final
{
    ...
    property() = default;
    property(Get&& getter, Set&& setter) : getter(std::move(getter)), setter(std::move(setter)) {}
...
struct property<Get, detail::none, GetClass, detail::none> final
{
    ...
    property() = default;
    property(Get&& getter, detail::none) : getter(std::move(getter)) {}
    ...
    static void set(v8::Local<v8::Name> name, v8::Local<v8::Value>, v8::PropertyCallbackInfo<void> const& info)
    {
        ...
        if (info.ShouldThrowOnError())
        {
            info.GetIsolate()->ThrowException(
                v8pp::to_v8(info.GetIsolate(), "read-only property " + from_v8<std::string>(info.GetIsolate(), name)));
        }
        // TODO: info.GetReturnValue().Set(false);
    }
};
