...
public:
    ...
    static constexpr bool is_bitcast_allowed =
        sizeof(T) == sizeof(void*) && std::is_default_constructible_v<T> && std::is_trivially_copyable_v<T>;
...
private:
    ...
    struct value_holder final : value_holder_base
    {
        ...
        value_holder(v8::Isolate* isolate, T&& data)
        {
            ...
            pext.SetWeak(this, [](v8::WeakCallbackInfo<value_holder> const& info) { delete info.GetParameter(); },
...
v8::Local<v8::FunctionTemplate> wrap_function_template(v8::Isolate* isolate, F&& func)
{
    ...
    return v8::FunctionTemplate::New(isolate, &detail::forward_function<Traits, F_type>,
...
v8::Local<v8::Function> wrap_function(v8::Isolate* isolate, std::string_view name, F&& func)
{
    ...
    v8::Local<v8::Function> fn =
        v8::Function::New(isolate->GetCurrentContext(), &detail::forward_function<Traits, F_type>,
                          detail::external_data::set(isolate, std::forward<F_type>(func)))
            .ToLocalChecked();
    if (!name.empty())
    {
